...
Four templates are available in the `templates/` folder. Each encodes a different philosophy and suits different situations. Read the selected template file before generating any output.
...
**Template selection:** Present the four templates with a one-line description of each and ask the user which approach fits their situation. 

### Phase 2: Draft

Once you have enough context and a chosen template:

1. Read the selected template file.
2. Generate a super concise and crispy PRD following the template's structure and rules. Dont deviate.

#### Writing principles — always apply these regardless of template:
